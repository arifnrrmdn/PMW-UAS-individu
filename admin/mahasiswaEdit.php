            ...
            <form enctype="multipart/form-data" method="post">
                <table width="100%" border="0">
                    <tr>
                        <td width="27%">NIM</td>
                        <td width="4%">:</td>
                        <td width="69%"><input type="text" name="nim" size="30" value="<?php echo $dataMhs[0]?>" 
                        readonly="readonly"/></td>
                    </tr>
                    <tr>
                        <td>NAMA</td>
                        <td>:</td>
                        <td><input type="text" name="nama" id="nama" size="30" value="<?php echo $dataMhs[1]?>"/></td>
                    </tr>
                    <tr>
                        <td>JENIS KELAMIN</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>PASSWORD</td>
                        <td>:</td>
                        <td><input type="text" name="password" id="password" size="30" value="<?php echo $dataMhs[4]?>"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
